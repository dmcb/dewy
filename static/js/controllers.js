...
controllers.controller('subscriptionController', ['$scope', '$timeout', '$rootScope', 'userFactory', 'authService', 'stripe',
	function ($scope, $timeout, $rootScope, userFactory, authService, stripe) {
